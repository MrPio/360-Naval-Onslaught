    ...
    public class DataManager
    {
        ...
        public readonly TurretModel[] Turrets =
        {
            ...
            new(
                ...
                baseSpeed: 220, baseRate: 40, baseDamage: 600, baseAmmo: 2, baseReload: 35,
        ...
        public readonly WaveModel[] Waves =
        {
            ...
            new(shipsChances: new List<float> { 0.35f, 0.5f, 0.885f, 1f, 1f },shipsCount:15,spawnSpeedMultiply:0.85f),
            ...
            new(shipsChances: new List<float> { 0.35f, 0.4f, 0.8f, 0.96f, 1f },shipsCount:16),
